...
}), _descriptor6 = _applyDecoratedDescriptor(_class2.prototype, 'iconBase', [_aureliaFramework.bindable], {
  enumerable: true,
  initializer: function initializer() {
    return _pickerGlobalOptions.globalExtraOptions.iconBase;
  }
}), _descriptor7 = _applyDecoratedDescriptor(_class2.prototype, 'withDateIcon', [_aureliaFramework.bindable], {
  enumerable: true,
  initializer: function initializer() {
    return _pickerGlobalOptions.globalExtraOptions.withDateIcon;
  }
}), _descriptor8 = _applyDecoratedDescriptor(_class2.prototype, 'bootstrapVersion', [_aureliaFramework.bindable], {
  enumerable: true,
  initializer: function initializer() {
    return _pickerGlobalOptions.globalExtraOptions.bootstrapVersion;
  }
}), _descriptor9 = _applyDecoratedDescriptor(_class2.prototype, 'noUI', [_aureliaFramework.bindable], {
  enumerable: true,
  initializer: function initializer() {
    return _pickerGlobalOptions.globalExtraOptions.noUI;
  }
}), _descriptor10 = _applyDecoratedDescriptor(_class2.prototype, 'buttonClass', [_aureliaFramework.bindable], {
  enumerable: true,
  initializer: function initializer() {
